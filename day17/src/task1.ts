function Partition(array: (number | string)[], fn: Function) {
...
function testCase() {
  const tests = [
    {
      input: [1, "1", "2", 2, 3, 4, "4"],
      callback: (x: number | string) => typeof x === "string",
      expected: [
        ["1", "2", "4"],
        [1, 2, 3, 4],
      ],
    ...
    {
      input: [1, 2, 3, { key: 4 }, 5],
      callback: (x: number | object) => typeof x === "object",
      expected: [[{ key: 4 }], [1, 2, 3, 5]],
    },
    {
      input: [],
      callback: (x: number) => typeof x === "number",
      expected: [[], []],
    },
    {
      input: [1, 2, 3, 4, 5],
      callback: (x: number) => typeof x === "string",
      expected: [[], [1, 2, 3, 4, 5]],
    },
    {
      input: [{}],
      callback: (x: object) => typeof x === "object",
      expected: [[{}], []],
    },
    {
      input: [1, 2, 3, 4, 5],
